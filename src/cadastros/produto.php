        ...
        <form method="post">
            <div class="form-group">
                ...
                <input type="text" name="nome" id="nome" required
                       value="<?= $editing ? htmlspecialchars($produto['nome']) : '' ?>">
            </div>

            <div class="form-group">
                <label for="fabricante">Fabricante:</label>
                <input type="text" name="fabricante" id="fabricante"
                       value="<?= $editing ? htmlspecialchars($produto['fabricante'] ?? '') : '' ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="id_grupo" id="id_grupo" required>
                    ...
                    <option value="<?= $grupo['id'] ?>" <?= $editing && $produto['id_grupo'] == $grupo['id'] ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <select name="tipo" id="tipo">
                    ...
                    <option value="<?= $tipo ?>" <?= $editing && ($produto['tipo'] ?? '') == $tipo ? 'selected' : '' ?>>
                        <?= $tipo ?>
                    </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="volume" id="volume"
                           value="<?= $editing ? htmlspecialchars($produto['volume'] ?? '') : '' ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="unidade_medida" id="unidade_medida">
                        ...
                        <option value="<?= $unidade ?>" <?= $editing && ($produto['unidade_medida'] ?? '') == $unidade ? 'selected' : '' ?>>
                            <?= $unidade ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <input type="text" name="preco" id="preco"
                       value="<?= $editing ? htmlspecialchars($produto['preco'] ?? '') : '' ?>">
            </div>
